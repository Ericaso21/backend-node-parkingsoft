...
class BlockController {
    ...
    public async list (req: Request, res: Response) {
        let blocks = await pool.query('SELECT bt.name_block_type, b.block_number, b.block_status, b.created_att FROM blocks b INNER JOIN block_types bt ON bt.id_block_type = b.fk_id_block_type WHERE b.block_status != 0');
